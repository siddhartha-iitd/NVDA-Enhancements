...
STATE_HASINPUTMESSAGE=0x20000000000
...
stateLabels={
	...
	# Translators: a state that denotes that the object(text) has an input message attached to it
	STATE_HASINPUTMESSAGE:_("has input message"),
}
